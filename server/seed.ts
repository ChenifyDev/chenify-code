...
const seedUsers: SeedUser[] = [
    ...
    },
    {
        ...
        posts: [
            ...
            {
                content:
                    "# 前端工程化实践指南\n\n这是一篇用来验证 AST 目录树多层渲染的示例文章，包含大量不同层级的标题，方便观察侧栏目录的缩进与跳转。\n\n## 一、构建工具\n\n现代前端工程离不开构建工具，下面分几个维度展开。\n\n### 1.1 Vite\n\nVite 基于原生 ESM，启动和热更新速度飞快。\n\n#### 冷启动优化\n\n依赖预构建可以减少开发时的请求数量。\n\n##### 依赖优化\n\n通过 `optimizeDeps` 排除不需要预构建的包。\n\n##### 插件扩展\n\n社区插件生态非常丰富，几乎任何需求都能找到对应插件。\n\n#### 生产构建\n\n生产环境使用 Rollup 打包，支持代码分割与按需加载。\n\n##### Tree Shaking\n\n利用 ESM 静态分析特性，去掉未使用的代码。\n\n### 1.2 Webpack\n\nWebpack 配置灵活但相对复杂，适合大型复杂工程。\n\n## 二、样式方案\n\n### 2.1 Tailwind CSS\n\n原子化 CSS 让样式维护成本大幅降低。\n\n#### 主题定制\n\n通过 `@theme` 定义设计令牌。\n\n##### 颜色变量\n\n颜色、间距、圆角等都可以抽象成变量。\n\n##### 断点体系\n\nTailwind 的响应式断点覆盖了常见设备。\n\n### 2.2 CSS Modules\n\n适合局部作用域隔离的场景。\n\n## 三、状态管理\n\n### 3.1 Zustand\n\nAPI 简洁，心智负担低。\n\n#### 异步状态\n\n配合中间件可以处理异步请求。\n\n### 3.2 其他方案\n\nRedux、MobX 等在特定场景仍有优势。\n\n## 四、总结\n\n本文展示了从构建、样式到状态的完整前端工程化路径。",
                tags: ["前端", "工程化", "目录树"],
                created_at: "2026-08-09 18:30:00",
            },
        ],
        drafts: [
            {
            ...
            },
            {
                ...
                updated_at: "2026-08-09 18:30:00",
            },
            {
